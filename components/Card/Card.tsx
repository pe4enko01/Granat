...
const Card: React.FunctionComponent<CardProps> = ({ img, cardTitle, cardDescribe }) => {
    return (
        ...
        <div className=" bg-gray-100 bg-opacity-75 px-4 pt-8 pb-8  rounded-lg overflow- text-center block w-64 h-90 mx-8">
            <Image src={`/${img}`} alt="logo" width={200} height={135} />
